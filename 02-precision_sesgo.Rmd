...
```{example, label="estimacion-boot-precision", name="Aproximación bootstrap de la precisión de estimaciones del tiempo de vida medio de microorganismos"}
<br> \vspace{0.5cm}
...
```{r boot-precision-media-mediana}
...
```{r boot-precision-media-mediana2}
library(boot)
...
```{theorem, label="jack-boot-precision"}
<br> \vspace{0.5cm}
...
```{example, label="estimacion-jack-precision", name="Aproximación jackknife de la precisión de estimaciones del tiempo de vida medio de microorganismos"}
<br> \vspace{0.5cm}
...
```{r jack-precision-media-mediana}
# Para la muestra de TIEMPOS DE VIDA, estima (plug-in) la precisión 
...
```{r jack-precision-media-mediana2}
library(bootstrap)

...
```{example, label="media-dt-desconocida-perc", name="Inferencia sobre la media con varianza desconocida, continuación"}
<br> \vspace{0.5cm}
...
```{example, label="media-dt-desconocida-persim", name="Inferencia sobre la media con varianza desconocida, continuación"}
<br> \vspace{0.5cm}
...
(ver Ejemplo \@ref(exm:media-dt-desconocida)):
```
...
```{example, label="estudio-sim-exp", name="Estudio de simulación"}
<br> \vspace{0.5cm}

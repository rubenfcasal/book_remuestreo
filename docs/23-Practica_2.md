# Práctica 2: Contrastes de hipótesis {#practica2}
...
\begin{center}\includegraphics[width=0.7\linewidth]{23-Practica_2_files/figure-latex/unnamed-chunk-4-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{23-Practica_2_files/figure-latex/unnamed-chunk-6-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{23-Practica_2_files/figure-latex/unnamed-chunk-12-1} \end{center}
...
de permutaciones.] descrito en la Práctica 1 (Sección \@ref(bootmod)):
...
\begin{center}\includegraphics[width=0.7\linewidth]{23-Practica_2_files/figure-latex/unnamed-chunk-21-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{23-Practica_2_files/figure-latex/unnamed-chunk-22-1} \end{center}
...
Adicionalmente, como se mostró en la Práctica 1, se puede emplear
...
\begin{center}\includegraphics[width=0.7\linewidth]{23-Practica_2_files/figure-latex/unnamed-chunk-24-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{23-Practica_2_files/figure-latex/unnamed-chunk-25-1} \end{center}
...
using nonparametric regression estimation. *Test*, 2, 161-188.

Pitman, E.J.G. (1937). Significance tests which may be applied to samples from any populations.
*Journal of the Royal Statistical Society*, Series B, 4, 119–130.

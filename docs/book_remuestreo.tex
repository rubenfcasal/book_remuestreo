...
\CommentTok{# g <- h}
\NormalTok{range_x <-}\StringTok{ }\KeywordTok{range}\NormalTok{(npden}\OperatorTok{$}\NormalTok{x) }\CommentTok{# Para fijar las posiciones de estimación}
\NormalTok{B <-}\StringTok{ }\DecValTok{1000}
...
\NormalTok{npdeng <-}\StringTok{ }\KeywordTok{density}\NormalTok{(x, }\DataTypeTok{bw =}\NormalTok{ g, }\DataTypeTok{from =}\NormalTok{ range_x[}\DecValTok{1}\NormalTok{], }\DataTypeTok{to =}\NormalTok{ range_x[}\DecValTok{2}\NormalTok{])}
...
\NormalTok{    den_boot <-}\StringTok{ }\KeywordTok{density}\NormalTok{(x_boot, }\DataTypeTok{bw =}\NormalTok{ h, }\DataTypeTok{from =}\NormalTok{ range_x[}\DecValTok{1}\NormalTok{], }\DataTypeTok{to =}\NormalTok{ range_x[}\DecValTok{2}\NormalTok{])}\OperatorTok{$}\NormalTok{y}
...
\NormalTok{    stat_den_boot[, k] <-}\StringTok{ }\NormalTok{den_boot }\OperatorTok{-}\StringTok{ }\NormalTok{npdeng}\OperatorTok{$}\NormalTok{y}
\NormalTok{\}}
...
\NormalTok{std_err <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(stat_den_boot, }\DecValTok{1}\NormalTok{, sd)}
...
\NormalTok{ic_inf_boot <-}\StringTok{ }\KeywordTok{pmax}\NormalTok{(npden}\OperatorTok{$}\NormalTok{y }\OperatorTok{-}\StringTok{ }\NormalTok{pto_crit[}\DecValTok{2}\NormalTok{, ], }\DecValTok{0}\NormalTok{)}
...
\KeywordTok{plot}\NormalTok{(npden, }\DataTypeTok{type=}\StringTok{"l"}\NormalTok{, }\DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.05}\NormalTok{), }\DataTypeTok{lwd =} \DecValTok{2}\NormalTok{)}
\KeywordTok{lines}\NormalTok{(npden}\OperatorTok{$}\NormalTok{x, }\KeywordTok{pmax}\NormalTok{(npden}\OperatorTok{$}\NormalTok{y }\OperatorTok{-}\StringTok{ }\NormalTok{bias, }\DecValTok{0}\NormalTok{)) }\CommentTok{# Ojo: no es una densidad}
...
\CommentTok{# range_x <- range(npden$x)}
\NormalTok{data.precip <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{h =}\NormalTok{ h, }\DataTypeTok{range_x =}\NormalTok{ range_x)}
...
\NormalTok{    out <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ xboot, }\DataTypeTok{h =}\NormalTok{ data}\OperatorTok{$}\NormalTok{h, }\DataTypeTok{range_x =}\NormalTok{ data}\OperatorTok{$}\NormalTok{range_x)}
\NormalTok{\}}

\NormalTok{statistic <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(data) }
                \KeywordTok{density}\NormalTok{(data}\OperatorTok{$}\NormalTok{x, }\DataTypeTok{bw =}\NormalTok{ data}\OperatorTok{$}\NormalTok{h, }\DataTypeTok{from =}\NormalTok{ range_x[}\DecValTok{1}\NormalTok{], }\DataTypeTok{to =}\NormalTok{ range_x[}\DecValTok{2}\NormalTok{])}\OperatorTok{$}\NormalTok{y}
...
\NormalTok{bias <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(res.boot}\OperatorTok{$}\NormalTok{t, }\DecValTok{2}\NormalTok{, mean, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{-}\StringTok{  }\NormalTok{npdeng}\OperatorTok{$}\NormalTok{y}
\NormalTok{std_err <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(res.boot}\OperatorTok{$}\NormalTok{t, }\DecValTok{2}\NormalTok{, sd, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ic_inf_boot <-}\StringTok{ }\KeywordTok{pmax}\NormalTok{(npden}\OperatorTok{$}\NormalTok{y }\OperatorTok{+}\StringTok{ }\NormalTok{npdeng}\OperatorTok{$}\NormalTok{y }\OperatorTok{-}\StringTok{ }\NormalTok{pto_crit[}\DecValTok{2}\NormalTok{, ], }\DecValTok{0}\NormalTok{)}
\NormalTok{ic_sup_boot <-}\StringTok{ }\NormalTok{npden}\OperatorTok{$}\NormalTok{y }\OperatorTok{+}\StringTok{ }\NormalTok{npdeng}\OperatorTok{$}\NormalTok{y }\OperatorTok{-}\StringTok{ }\NormalTok{pto_crit[}\DecValTok{1}\NormalTok{, ]}
...
\KeywordTok{lines}\NormalTok{(npden}\OperatorTok{$}\NormalTok{x, }\KeywordTok{pmax}\NormalTok{(npden}\OperatorTok{$}\NormalTok{y }\OperatorTok{-}\StringTok{ }\NormalTok{bias, }\DecValTok{0}\NormalTok{))}
...
\KeywordTok{matplot}\NormalTok{(npden}\OperatorTok{$}\NormalTok{x, }\KeywordTok{pmax}\NormalTok{(npden}\OperatorTok{$}\NormalTok{y }\OperatorTok{+}\StringTok{ }\NormalTok{npdeng}\OperatorTok{$}\NormalTok{y }\OperatorTok{-}\StringTok{ }\KeywordTok{t}\NormalTok{(res.boot}\OperatorTok{$}\NormalTok{t), }\DecValTok{0}\NormalTok{), }\DataTypeTok{type =} \StringTok{"l"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"darkgray"}\NormalTok{)}
\KeywordTok{lines}\NormalTok{(npden, }\DataTypeTok{lwd =} \DecValTok{2}\NormalTok{)}
\KeywordTok{lines}\NormalTok{(npden}\OperatorTok{$}\NormalTok{x, npden}\OperatorTok{$}\NormalTok{y }\OperatorTok{-}\StringTok{ }\NormalTok{bias)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{g <-}\StringTok{ }\NormalTok{h }\OperatorTok{*}\StringTok{ }\NormalTok{n}\OperatorTok{^}\NormalTok{(}\DecValTok{4}\OperatorTok{/}\DecValTok{45}\NormalTok{) }\CommentTok{# h*n^(-1/9)/n^(-1/5)}
\CommentTok{# g <- h}
\NormalTok{fitg <-}\StringTok{ }\KeywordTok{locpoly}\NormalTok{(x, y, }\DataTypeTok{bandwidth =}\NormalTok{ g) }\CommentTok{# puntos de estimación/predicción}
\CommentTok{# fitg$y <- predict(fitg, newdata = fitg$x) }
\NormalTok{estg <-}\StringTok{ }\KeywordTok{approx}\NormalTok{(fitg, }\DataTypeTok{xout =}\NormalTok{ x)}\OperatorTok{$}\NormalTok{y }\CommentTok{# puntos observaciones}
\CommentTok{# estg <- predict(fitg)}
\CommentTok{# resid2 <- y - estg # resid2 <- residuals(fitg)}
...
\ControlFlowTok{for}\NormalTok{ (k }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{B) \{}
\NormalTok{    y_boot <-}\StringTok{ }\NormalTok{estg }\OperatorTok{+}\StringTok{ }\KeywordTok{sample}\NormalTok{(resid0, }\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{)}
...
\NormalTok{    stat_fit_boot[ , k] <-}\StringTok{ }\NormalTok{fit_boot }\OperatorTok{-}\StringTok{ }\NormalTok{fitg}\OperatorTok{$}\NormalTok{y}
\NormalTok{\}}
...
\NormalTok{    y_boot <-}\StringTok{ }\NormalTok{estg }\OperatorTok{+}\StringTok{ }\KeywordTok{sample}\NormalTok{(resid0, }\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{    fit_boot <-}\StringTok{ }\KeywordTok{locpoly}\NormalTok{(x, y_boot, }\DataTypeTok{bandwidth =}\NormalTok{ h)}\OperatorTok{$}\NormalTok{y}
\NormalTok{    pred_boot <-}\StringTok{ }\NormalTok{fitg}\OperatorTok{$}\NormalTok{y }\OperatorTok{+}\StringTok{ }\KeywordTok{sample}\NormalTok{(resid0, n_pre, }\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{)}
...
\NormalTok{    y_boot <-}\StringTok{ }\NormalTok{estg }\OperatorTok{+}\StringTok{ }\NormalTok{resid}\OperatorTok{*}\NormalTok{rwild}
...
\CommentTok{# Calculo del sesgo y error estándar}
\NormalTok{bias <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(fit_boot, }\DecValTok{1}\NormalTok{, mean, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{-}\StringTok{ }\NormalTok{fitg}\OperatorTok{$}\NormalTok{y}

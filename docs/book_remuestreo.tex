...
\hypertarget{cap1-implementacion}{%
...
\hypertarget{deficiencias-del-bootstrap-uniforme}{%
\section{Deficiencias del bootstrap uniforme}\label{deficiencias-del-bootstrap-uniforme}}
...
\hypertarget{cap5-norm}{%
\section{Intervalos basados en la distribución normal asintótica}\label{cap5-norm}}
...
\hypertarget{cap5-basic}{%
\section{Método percentil (básico)}\label{cap5-basic}}
...
\hypertarget{cap5-perc-t}{%
\section{\texorpdfstring{Método percentil-\emph{t}}{Método percentil-t}}\label{cap5-perc-t}}
...
\hypertarget{cap5-perc-t-sim}{%
\section{\texorpdfstring{Método percentil-\emph{t} simetrizado}{Método percentil-t simetrizado}}\label{cap5-perc-t-sim}}
...
\midrule
\endhead
Percentil & \(O_{P}\left( n^{-\frac{1}{2}}\right)\) & \(O_{P}\left(n^{-\frac{1}{2}} \right)\)\tabularnewline
Percentil-\(t\) & \(O_{P}\left( n^{-1} \right)\) & \(O_{P}\left( n^{-1} \right)\)\tabularnewline
Percentil-\(t\) simetrizado & \(O_{P}\left( n^{-1} \right)\) & \(O_{P}\left( n^{-\frac{3}{2}} \right)\)\tabularnewline
\bottomrule
\end{longtable}

\hypertarget{cap5-ejem}{%
\section{Ejemplos}\label{cap5-ejem}}

\BeginKnitrBlock{example}[Inferencia sobre la media con varianza desconocida, continuación]
\protect\hypertarget{exm:media-dt-desconocida-persim}{}{\label{exm:media-dt-desconocida-persim} \iffalse (Inferencia sobre la media con varianza desconocida, continuación) \fi{} } \vspace{0.5cm}
...
\NormalTok{\}}
\NormalTok{lynx}\FloatTok{.1}\NormalTok{ <-}\StringTok{ }\KeywordTok{tsboot}\NormalTok{(}\KeywordTok{log}\NormalTok{(lynx), lynx.fun, }\DataTypeTok{R=}\DecValTok{99}\NormalTok{, }\DataTypeTok{l=}\DecValTok{20}\NormalTok{, }\DataTypeTok{sim=}\StringTok{"fixed"}\NormalTok{)}
\NormalTok{lynx}\FloatTok{.1}
\KeywordTok{ts.plot}\NormalTok{(}\KeywordTok{ts}\NormalTok{(lynx}\FloatTok{.1}\OperatorTok{$}\NormalTok{t[}\DecValTok{1}\NormalTok{,}\DecValTok{3}\OperatorTok{:}\DecValTok{116}\NormalTok{],}\DataTypeTok{start=}\KeywordTok{c}\NormalTok{(}\DecValTok{1821}\NormalTok{,}\DecValTok{1}\NormalTok{)),}
        \DataTypeTok{main=}\StringTok{"Block simulation, l=20"}\NormalTok{)}
\KeywordTok{boot.array}\NormalTok{(lynx}\FloatTok{.1}\NormalTok{)[}\DecValTok{1}\NormalTok{,]}
\KeywordTok{table}\NormalTok{(lynx}\FloatTok{.1}\OperatorTok{$}\NormalTok{t[,}\DecValTok{1}\NormalTok{])}
\KeywordTok{var}\NormalTok{(lynx}\FloatTok{.1}\OperatorTok{$}\NormalTok{t[,}\DecValTok{2}\NormalTok{])}
\KeywordTok{qqnorm}\NormalTok{(lynx}\FloatTok{.1}\OperatorTok{$}\NormalTok{t[,}\DecValTok{2}\NormalTok{]);}
\KeywordTok{abline}\NormalTok{(}\KeywordTok{mean}\NormalTok{(lynx}\FloatTok{.1}\OperatorTok{$}\NormalTok{t[,}\DecValTok{2}\NormalTok{]),}\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{var}\NormalTok{(lynx}\FloatTok{.1}\OperatorTok{$}\NormalTok{t[,}\DecValTok{2}\NormalTok{])),}\DataTypeTok{lty=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{.Random.seed <-}\StringTok{ }\NormalTok{lynx}\FloatTok{.1}\OperatorTok{$}\NormalTok{seed}
\NormalTok{lynx}\FloatTok{.2}\NormalTok{ <-}\StringTok{ }\KeywordTok{tsboot}\NormalTok{(}\KeywordTok{log}\NormalTok{(lynx), lynx.fun, ...}
\CommentTok{# lynx.2}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(DNI)}
\NormalTok{sunspot}\FloatTok{.1}\NormalTok{ <-}\StringTok{ }\KeywordTok{tsboot}\NormalTok{(sunspot.year, ...}
\NormalTok{.Random.seed <-}\StringTok{ }\NormalTok{sunspot}\FloatTok{.1}\OperatorTok{$}\NormalTok{seed }\CommentTok{# set.seed(DNI)}
\NormalTok{sunspot}\FloatTok{.2}\NormalTok{ <-}\StringTok{ }\KeywordTok{tsboot}\NormalTok{(sunspot.year, ...}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data <-}\StringTok{ }\NormalTok{Prestige}
\NormalTok{r <-}\StringTok{ }\KeywordTok{cor}\NormalTok{(data}\OperatorTok{$}\NormalTok{income, data}\OperatorTok{$}\NormalTok{prestige)}
\NormalTok{z <-}\StringTok{ }\KeywordTok{atanh}\NormalTok{(r)}
\NormalTok{z}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{statistic <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(data, i)\{}
\NormalTok{  remuestra <-}\StringTok{ }\NormalTok{data[i, ]}
\NormalTok{  r <-}\StringTok{ }\KeywordTok{cor}\NormalTok{(remuestra}\OperatorTok{$}\NormalTok{income, remuestra}\OperatorTok{$}\NormalTok{prestige)}
\NormalTok{  r}
\NormalTok{\}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# La distribución bootstrap en la escala transformada}
\CommentTok{# se aproxima más a la normalidad...}
...
\hypertarget{implementaciuxf3n-con-el-paquete-boot}{%
\subsection{\texorpdfstring{Implementación con el paquete \texttt{boot}}{Implementación con el paquete boot}}\label{implementaciuxf3n-con-el-paquete-boot}}
